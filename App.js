      ...
      <View>
          ...
          <DataTable>
            ...
            {this.state.users.length 
                      ...
                      <DataTable.Row key={index}>
                        ...
                        <DataTable.Cell>
                          <View>
                              ...
                              <Button title='Edit' onPress={()=>{this.handleQuickEdit(index)}}/>
                              <Button title='Delete' onPress={()=>{this.handleSave(index, true);}}/>
                          </View>
                        </DataTable.Cell>
                      </DataTable.Row>
                  )
              ...
              :
                <DataTable.Row><Text>Enter Information</Text></DataTable.Row>
            }
            </View>
          </DataTable>
      </View>
